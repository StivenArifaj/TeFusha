            ...
            if (state.events.isEmpty) {
              return Center(
                child: Column(
                  ...
                  children: [
                    Icon(Icons.emoji_events_outlined, size: 64, color: AppColors.textHint.withOpacity(0.5)),
                    const SizedBox(height: 16),
                    const Text("Nuk ka turne aktivë për momentin.", style: TextStyle(color: AppColors.textSecondary)),
                  ],
                ),
              );
            }
